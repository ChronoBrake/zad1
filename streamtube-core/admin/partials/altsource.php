...
<td data-title="<?php esc_attr_e( 'Action', 'streamtube-core' )?>">
	<div class="d-flex gap-3">
		<button type="button" class="btn btn-danger button btn-sm source_remove p-1">
			<span class="dashicons dashicons-minus icon-minus"></span>
		</button>					
		<button type="button" class="btn btn-primary button button-primary btn-sm source_add p-1">

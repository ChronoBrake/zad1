...
?>
<form class="form-search-collections">
	<div class="mb-3">
		<?php printf(
			'<input id="search-collection-input" name="search" type="text" class="form-control form-control-sm" placeholder="%s" onkeyup="searchCollections()" autocomplete="off">',

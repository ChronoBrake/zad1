...
class Streamtube_Core_Widget_Recorded_Videos extends WP_Widget{
    ...
    function __construct(){
        ...
        parent::__construct( 
            ...
            array( 
                ...
                'description'   =>  esc_html__('[StreamTube] Show Recorded Videos of current/given Live Stream', 'streamtube-core')
            )
        );
    }
    ...
    private function get_stream_status_label( $recorded ){
         ...
         * @since 2.4
         */
        $output = apply_filters( 'streamtube/core/widget/recorded_videos', $output, $recorded );
    ...
    public function widget( $args, $instance ) {
        ...
        global $cloudflare_recorded_videos, $cloudflare_stream;
        ...
        if( ! is_array( $cloudflare_recorded_videos ) ){
            return;
        }

        $per_page = min( count( $cloudflare_recorded_videos ), (int)$posts_per_page );
        ...
        echo $args['before_widget'];
            ...
            $recorded_videos = $cloudflare_recorded_videos;

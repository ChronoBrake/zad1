...
$heading = apply_filters( 'streamtube/core/user/profile/following', esc_html__( 'Following', 'streatube-core' ));

?>
<section class="section-profile profile-following py-5 pb-0 m-0">
    ...
    <div class="<?php echo sanitize_html_class( $content_width );?>">
        ...
        $user_ids = wpuf_get_follow_users( get_queried_object_id(), 'following' );

!function(t, e) {
    ...
    function y(t, e, i) {
        ...
        e)
            for (o in v)
                (s = e[o] || e.getAttribute && e.getAttribute(o)) && r.setAttribute(o, s);
    ...
    var I = function(t) {
        var e, i, n, o, s, r, a, l, c, u, d, h, f, p, m, g, v, y, w, b = "sizzle" + 1 * new Date, x = t.document, S = 0, C = 0, I = lt(), _ = lt(), M = lt(), T = lt(), L = function(t, e) {
            return t === e && (d = !0),
            0
        }, E = {}.hasOwnProperty, N = [], D = N.pop, k = N.push, j = N.push, A = N.slice, z = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", W = "\\[" + P + "*(" + R + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + P + "*\\]", H = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", B = new RegExp(P + "+","g"), q = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$","g"), F = new RegExp("^" + P + "*," + P + "*"), Q = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), U = new RegExp(P + "|>"), Y = new RegExp(H), Z = new RegExp("^" + R + "$"), G = {
            ID: new RegExp("^#(" + R + ")"),
            CLASS: new RegExp("^\\.(" + R + ")"),
            TAG: new RegExp("^(" + R + "|[*])"),
            ATTR: new RegExp("^" + W),
        ...
        function at(t, e, n, o) {
            var s, a, c, u, d, p, v, y = e && e.ownerDocument, S = e ? e.nodeType : 9;
            if (n = n || [],
            ...
            m)) {
                    ...
                    if (s = d[1]) {
                        if (9 === S) {
                            ...
                            if (c.id === s)
                                return n.push(c),
                                n
                        } else if (y && (c = y.getElementById(s)) && w(e, c) && c.id === s)
                            return n.push(c),
                            n
                    } else {
                        if (d[2])
                ...
                if (i.qsa && !T[t + " "] && (!g || !g.test(t)) && (1 !== S || "object" !== e.nodeName.toLowerCase())) {
                    if (v = t,
                    y = e,
                    1 === S && U.test(t)) {
        ...
        h = at.setDocument = function(t) {
            ...
            return r !== f && 9 === r.nodeType && r.documentElement && (p = (f = r).documentElement,
            m = !s(f),
            x !== f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", st, !1) : o.attachEvent && o.attachEvent("onunload", st)),
            ...
            L = e ? function(t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !i.sortDetached && e.compareDocumentPosition(t) === n ? t === f || t.ownerDocument === x && w(x, t) ? -1 : e === f || e.ownerDocument === x && w(x, e) ? 1 : u ? z(u, t) - z(u, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return d = !0,
                ...
                if (!o || !s)
                    return t === f ? -1 : e === f ? 1 : o ? -1 : s ? 1 : u ? z(u, t) - z(u, e) : 0;
                if (o === s)
                    return ht(t, e);
                ...
                for (; r[n] === a[n]; )
                    n++;
                return n ? ht(r[n], a[n]) : r[n] === x ? -1 : a[n] === x ? 1 : 0
            }
            ),
            f
        }
        ...
        (n = at.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return G.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && Y.test(i) && (e = r(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, i, n, o) {
                    ...
                    : function(e, i, l) {
                        var c, u, d, h, f, p, m = s !== r ? "nextSibling" : "previousSibling", g = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, w = !1;
                        if (g) {
                            if (s) {
                                for (; m; ) {
                                    for (h = e; h = h[m]; )
        ...
        function Ct(t, e, i, n, o, s) {
            ...
            o && !o[b] && (o = Ct(o, s)),
            ct(function(s, r, a, l) {
                var c, u, d, h = [], f = [], p = r.length, m = s || function(t, e, i) {
                    for (var n = 0, o = e.length; n < o; n++)
                        at(t, e[n], i);
                    return i
                }(e || "*", a.nodeType ? [a] : a, []), g = !t || !s && e ? m : St(m, h, t, a, l), v = i ? o || (s ? t : p || n) ? [] : r : g;
                if (i && i(g, v, a, l),
                n)
                    for (c = St(v, f),
                    n(c, [], a, l),
                ...
                if (s) {
                    if (o || t) {
                        ...
                        for (u = v.length; u--; )
                            (d = v[u]) && -1 < (c = o ? z(s, d) : h[u]) && (s[c] = !(r[c] = d))
                    }
                } else
                    v = St(v === r ? v.splice(p, v.length) : v),
                    o ? o(null, r, v, l) : j.apply(r, v)
            })
        }
        function It(t) {
            for (var e, i, o, s = t.length, r = n.relative[t[0].type], a = r || n.relative[" "], l = r ? 1 : 0, u = bt(function(t) {
                return t === e
            }, a, !0), d = bt(function(t) {
                return -1 < z(e, t)
                ...
                if (i = n.relative[t[l].type])
                    ...
                    if ((i = n.filter[t[l].type].apply(null, t[l].matches))[b]) {
                        ...
                        return Ct(1 < l && xt(h), 1 < l && wt(t.slice(0, l - 1).concat({
                            value: " " === t[l - 2].type ? "*" : ""
                        })).replace(q, "$1"), i, l < o && It(t.slice(l, o)), o < s && It(t = t.slice(o)), o < s && wt(t))
                    }
                    h.push(i)
                }
            return xt(h)
        ...
        r = at.tokenize = function(t, e) {
            ...
            c = n.preFilter; a; ) {
                ...
                a = a.slice(i.length)),
                n.filter)
                    !(o = G[r].exec(a)) || c[r] && !(o = c[r](o)) || (i = o.shift(),
                    s.push({
                        value: i,
                        type: r,
                        matches: o
                ...
                u = function(t, e, i, r, u) {
                    ...
                    a && y !== v) {
                        ...
                        if (t) {
                            if (0 < v)
                                for (; y--; )
                                    w[y] || b[y] || (b[y] = D.call(r));
                            b = St(b)
                        }
                        j.apply(r, b),
                        u && !t && 0 < b.length && 1 < v + s.length && at.uniqueSort(r)
                    }
                    return u && (S = I,
                    c = x),
                    w
        ...
        l = at.select = function(t, e, i, o) {
            var s, l, c, u, d, h = "function" == typeof t && t, f = !o && r(t = h.selector || t);
            if (i = i || [],
            1 === f.length) {
                ...
                for (s = G.needsContext.test(t) ? 0 : l.length; s-- && (c = l[s],
                !n.relative[u = c.type]); )
    ...
    x.fn.extend({
        ...
        is: function(t) {
            return !!N(this, "string" == typeof t && T.test(t) ? x(t) : t || [], !1).length
        }
    });
    var D, k = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    x.Callbacks = function(t) {
        ...
        i) : x.extend({}, t);
        var n, o, s, r, a = [], l = [], c = -1, u = function() {
            for (r = r || t.once,
            s = n = !0; l.length; c = -1)
    ...
    x.extend({
              ...
              , o = {
                ...
                then: function(e, n, o) {
                            ...
                            var a = this
                              ...
                              , c = function() {
                                ...
                                if (!(e < s)) {
                                    ...
                                    m(c) ? o ? c.call(t, r(s, i, P, o), r(s, i, R, o)) : (s++,
                                    c.call(t, r(s, i, P, o), r(s, i, R, o), r(s, i, P, i.notifyWith))) : (n !== P && (a = void 0,
                                    l = [t]),
                                    (o || i.resolveWith)(a, l))
                                }
                            }
                    ...
                    return x.Deferred(function(t) {
                        i[0][3].add(r(0, t, m(o) ? o : P, t.notifyWith)),
                        i[1][3].add(r(0, t, m(e) ? e : P)),
                        i[2][3].add(r(0, t, m(n) ? n : R))
                    }).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (W(t, r.done(a(i)).resolve, r.reject, !e),
    ...
    x.ready.then = B.then,
    "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll ? t.setTimeout(x.ready) : (n.addEventListener("DOMContentLoaded", q),
    ...
    $.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    i = (e = Array.isArray(e) ? e.map(Z) : (e = Z(e))in n ? [e] : e.match(O) || []).length;
                    for (; i--; )
                        delete n[e[i]]
                }
    ...
    x.fn.extend({
        data: function(t, e) {
            ...
            if (void 0 === t) {
                ...
                1 === s.nodeType && !X.get(s, "hasDataAttrs"))) {
                    for (i = r.length; i--; )
                        r[i] && 0 === (n = r[i].name).indexOf("data-") && (n = Z(n.slice(5)),
                        tt(s, n, o[n]));
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var i;
                if (s && void 0 === e)
                    return void 0 !== (i = V.get(s, t)) ? i : void 0 !== (i = tt(s, t)) ? i : void 0;
                this.each(function() {
                    V.set(this, t, e)
                })
    ...
    x.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; r--; )
                (i = X.get(s[r], t + "queueHooks")) && i.empty && (n++,
                i.empty.add(a));
            return a(),
            o.promise(e)
        }
    ...
    var ut = {};
    function dt(t, e) {
        for (var i, n, o, s, r, a, l, c = [], u = 0, d = t.length; u < d; u++)
            (n = t[u]).style && (i = n.style.display,
            e ? ("none" === i && (c[u] = X.get(n, "display") || null,
            c[u] || (n.style.display = "")),
            "" === n.style.display && at(n) && (c[u] = (l = r = s = void 0,
            r = (o = n).ownerDocument,
            a = o.nodeName,
            (l = ut[a]) || (s = r.body.appendChild(r.createElement(a)),
            l = x.css(s, "display"),
    ...
    function xt(t, e, i, n, o) {
        ...
        f = 0; s = h[f++]; )
            ...
            r = gt(d.appendChild(s), "script"),
            c && vt(r),
            i)
                for (u = 0; s = r[u++]; )
                    pt.test(s.type || "") && i.push(s);
        return d
    }
        ...
        x.event.add(t, e, {
            ...
            handler: function(t) {
                ...
                if (1 & t.isTrigger && this[e]) {
                    ...
                    n = i(this, e),
                    this[e](),
                    r !== (o = X.get(this, e)) || n ? X.set(this, e, !1) : o = {},
                    r !== o)
                        return t.stopImmediatePropagation(),
                        t.preventDefault(),
                        o.value
                } else
                    r.length && (X.set(this, e, {
    ...
    x.event = {
        ...
        add: function(t, e, i, n, o) {
            var s, r, a, l, c, u, d, h, f, p, m, g = X.get(t);
            if (g)
                ...
                c = (e = (e || "").match(O) || [""]).length; c--; )
                    ...
                    d.setup && !1 !== d.setup.call(t, n, p, r) || t.addEventListener && t.addEventListener(f, r)),
        ...
        remove: function(t, e, i, n, o) {
            var s, r, a, l, c, u, d, h, f, p, m, g = X.hasData(t) && X.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(O) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        r = s = h.length; s--; )
                            u = h[s],
                            !o && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (h.splice(s, 1),
                            u.selector && h.delegateCount--,
                            d.remove && d.remove.call(t, u));
                        r && !h.length && (d.teardown && !1 !== d.teardown.call(t, p, g.handle) || x.removeEvent(t, f, g.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(t) {
            var e, i, n, o, s, r, a = x.event.fix(t), l = new Array(arguments.length), c = (X.get(this, "events") || {})[a.type] || [], u = x.event.special[a.type] || {};
            for (l[0] = a,
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[o = (n = e[i]).selector + " "] && (r[o] = n.needsContext ? -1 < x(o, this).index(c) : x.find(o, this, null, [c]).length),
                            r[o] && s.push(n);
                        s.length && a.push({
                            elem: c,
                            handlers: s
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && L(e, "input") && Et(e, "click", _t),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && L(e, "input") && Et(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    x.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? _t : Mt,
    ...
    function Rt(t, e, i, n) {
        e = r.apply([], e);
        var o, s, a, l, c, u, d = 0, h = t.length, f = h - 1, g = e[0], v = m(g);
        if (v || 1 < h && "string" == typeof g && !p.checkClone && kt.test(g))
            return t.each(function(o) {
                var s = t.eq(o);
                v && (e[0] = g.call(this, o, s.html())),
                Rt(s, e, i, n)
            });
        if (h && (s = (o = xt(e, t[0].ownerDocument, !1, t, n)).firstChild,
        1 === o.childNodes.length && (o = s),
        s || n)) {
            for (l = (a = x.map(gt(o, "script"), zt)).length; d < h; d++)
                c = o,
                d !== f && (c = x.clone(c, !0, !0),
    ...
    function Wt(t, e, i) {
        for (var n, o = e ? x.filter(e, t) : t, s = 0; null != (n = o[s]); s++)
            ...
            n.parentNode && (i && st(n) && vt(gt(n, "script")),
    ...
    x.extend({
        ...
        clone: function(t, e, i) {
            var n, o, s, r, a, l, c, u = t.cloneNode(!0), d = st(t);
            if (!(p.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || x.isXMLDoc(t)))
                for (r = gt(u),
                n = 0,
                o = (s = gt(t)).length; n < o; n++)
                    a = s[n],
                    "input" === (c = (l = r[n]).nodeName.toLowerCase()) && ht.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (s = s || gt(t),
                    r = r || gt(u),
                    ...
                    Pt(t, u);
            return 0 < (r = gt(u, "script")).length && vt(r, !d && gt(t, "script")),
            u
        },
    ...
    function Ft(t, e, i) {
        ...
        return (i = i || Bt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || st(t) || (r = x.style(t, e)),
        !p.pixelBoxStyles() && Ht.test(r) && qt.test(e) && (n = a.width,
        o = a.minWidth,
        s = a.maxWidth,
    ...
    !function() {
        ...
        var o, s, r, a, l, c = n.createElement("div"), u = n.createElement("div");
    ...
    function te(t, e, i, n, o, s) {
        ...
        if (i === (n ? "border" : "content"))
            return 0;
        for (; r < 4; r += 2)
            "margin" === i && (l += x.css(t, i + nt[r], !0, o)),
            n ? ("content" === i && (l -= x.css(t, "padding" + nt[r], !0, o)),
            "margin" !== i && (l -= x.css(t, "border" + nt[r] + "Width", !0, o))) : (l += x.css(t, "padding" + nt[r], !0, o),
            "padding" !== i ? l += x.css(t, "border" + nt[r] + "Width", !0, o) : a += x.css(t, "border" + nt[r] + "Width", !0, o));
    ...
    function ee(t, e, i) {
        ...
        return (!p.boxSizingReliable() && o || "auto" === r || !parseFloat(r) && "inline" === x.css(t, "display", !1, n)) && t.getClientRects().length && (o = "border-box" === x.css(t, "boxSizing", !1, n),
        (s = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) + te(t, e, i || (o ? "border" : "content"), s, n, r) + "px"
    }
    ...
    x.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, s, r, a = Z(e), l = Xt.test(e), c = t.style;
                if (l || (e = Gt(a)),
                r = x.cssHooks[e] || x.cssHooks[a],
                void 0 === i)
                    return r && "get"in r && void 0 !== (o = r.get(t, !1, n)) ? o : c[e];
                "string" == (s = typeof i) && (o = it.exec(i)) && o[1] && (i = ct(t, e, o),
                s = "number"),
    ...
    x.each(["height", "width"], function(t, e) {
        x.cssHooks[e] = {
            ...
            set: function(t, i, n) {
                var o, s = Bt(t), r = !p.scrollboxSize() && "absolute" === s.position, a = (r || n) && "border-box" === x.css(t, "boxSizing", !1, s), l = n ? te(t, e, n, a, s) : 0;
                return a && r && (l -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(s[e]) - te(t, e, "border", !1, s) - .5)),
    ...
    x.cssHooks.marginLeft = Qt(p.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Ft(t, "marginLeft")) || t.getBoundingClientRect().left - lt(t, {
                marginLeft: 0
            }, function() {
    ...
    x.fx.step = {};
    var ne, oe, se, re, ae = /^(?:toggle|show|hide)$/, le = /queueHooks$/;
    function ce() {
    ...
    function he(t, e, i) {
        for (var n, o = (fe.tweeners[e] || []).concat(fe.tweeners["*"]), s = 0, r = o.length; s < r; s++)
            if (n = o[s].call(i, e, t))
                return n
    }
    function fe(t, e, i) {
        var n, o, s = 0, r = fe.prefilters.length, a = x.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var e = ne || ue(), i = Math.max(0, c.startTime + c.duration - e), n = 1 - (i / c.duration || 0), s = 0, r = c.tweens.length; s < r; s++)
                c.tweens[s].run(n);
    ...
    x.Animation = x.extend(fe, {
        ...
        prefilters: [function(t, e, i) {
            var n, o, s, r, a, l, c, u, d = "width"in e || "height"in e, h = this, f = {}, p = t.style, m = t.nodeType && at(t), g = X.get(t, "fxshow");
    ...
    x.fn.extend({
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"),
            this.each(function() {
                var e, i = X.get(this), n = i[t + "queue"], o = i[t + "queueHooks"], s = x.timers, r = n ? n.length : 0;
                for (i.finish = !0,
                x.queue(this, t, []),
    ...
    re = n.createElement("select").appendChild(n.createElement("option")),
    se.type = "checkbox",
    p.checkOn = "" !== se.value,
    p.optSelected = re.selected,
    (se = n.createElement("input")).value = "t",
    se.type = "radio",
    p.radioValue = "t" === se.value;
    ...
    x.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== s && 8 !== s && 2 !== s)
                return void 0 === t.getAttribute ? x.prop(t, e, i) : (1 === s && x.isXMLDoc(t) || (o = x.attrHooks[e.toLowerCase()] || (x.expr.match.bool.test(e) ? pe : void 0)),
    ...
    x.extend(x.event, {
        trigger: function(e, i, o, s) {
            var r, a, l, c, u, h, f, p, v = [o || n], y = d.call(e, "type") ? e.type : e, w = d.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = p = l = o = o || n,
            ...
            s || !f.trigger || !1 !== f.trigger.apply(o, i))) {
                ...
                for (r = 0; (a = v[r++]) && !e.isPropagationStopped(); )
                    p = a,
                    e.type = 1 < r ? c : f.bindType || y,
                    (h = (X.get(a, "events") || {})[e.type] && X.get(a, "handle")) && h.apply(a, i),
                    (h = u && a[u]) && h.apply && G(a) && (e.result = h.apply(a, i),
                    !1 === e.result && e.preventDefault());
                return e.type = y,
                s || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), i) || !G(o) || u && m(o[y]) && !g(o) && ((l = o[u]) && (o[u] = null),
                x.event.triggered = y,
    ...
    function De(t, e, i, n) {
        ...
        if (Array.isArray(e))
            x.each(e, function(e, o) {
                i || Te.test(t) ? n(t, o) : De(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, i, n)
            });
    ...
    x.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !x(this).is(":disabled") && Ne.test(this.nodeName) && !Ee.test(t) && (this.checked || !ht.test(t))
            }).map(function(t, e) {
                var i = x(this).val();
    ...
    function qe(t) {
        return function(e, i) {
            "string" != typeof e && (i = e,
            e = "*");
            var n, o = 0, s = e.toLowerCase().match(O) || [];
            if (m(i))
                for (; n = s[o++]; )
                    "+" === n[0] ? (n = n.slice(1) || "*",
    ...
    x.extend({
        ...
        ajax: function(e, i) {
            ...
            e = void 0),
            i = i || {};
            var o, s, r, a, l, c, u, d, h, f, p = x.ajaxSetup({}, i), m = p.context || p, g = p.context && (m.nodeType || m.jquery) ? x(m) : x.event, v = x.Deferred(), y = x.Callbacks("once memory"), w = p.statusCode || {}, b = {}, S = {}, C = "canceled", I = {
                readyState: 0,
            ...
            s = p.url.replace(je, ""),
            p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(ke, "+")) : (f = p.url.slice(s.length),
            p.data && (p.processData || "string" == typeof p.data) && (s += (Me.test(s) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (s = s.replace(Ae, "$1"),
            f = (Me.test(s) ? "&" : "?") + "_=" + _e++ + f),
            p.url = s + f),
            p.ifModified && (x.lastModified[s] && I.setRequestHeader("If-Modified-Since", x.lastModified[s]),
            x.etag[s] && I.setRequestHeader("If-None-Match", x.etag[s])),
            ...
            function _(e, i, n, a) {
                ...
                c ? (p.ifModified && ((S = I.getResponseHeader("Last-Modified")) && (x.lastModified[s] = S),
                (S = I.getResponseHeader("etag")) && (x.etag[s] = S)),
    ...
    x.ajaxPrefilter("json jsonp", function(e, i, n) {
        var o, s, r, a = !1 !== e.jsonp && ($e.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && $e.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0])
            return o = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace($e, "$1" + o) : !1 !== e.jsonp && (e.url += (Me.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    x.parseHTML = function(t, e, i) {
        ...
        r = !i && [],
        (s = E.exec(t)) ? [e.createElement(s[1])] : (s = xt([t], e, r),
    ...
    x.offset = {
        setOffset: function(t, e, i) {
            var n, o, s, r, a, l, c = x.css(t, "position"), u = x(t), d = {};
...
function(t, e) {
    ...
    var M = "carousel"
      ...
      , z = {
        ...
        LOAD_DATA_API: "load" + L + E,
        CLICK_DATA_API: "click" + L + E
    }
      , O = "active"
      ...
      , H = function() {
        ...
        i._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                ...
                e(this._element.querySelectorAll(".carousel-item img")).on(z.DRAG_START, function(t) {
                ...
                this._element.classList.add("pointer-event")) : (e(this._element).on(z.TOUCHSTART, function(t) {
                    return i(t)
                }),
        ...
        i._getItemByDirection = function(t, e) {
            ...
            if ((n && 0 === o || i && o === s) && !this._config.wrap)
                return e;
            var r = (o + (t === A ? -1 : 1)) % this._items.length;
        ...
        i._slide = function(t, i) {
            var n, o, s, r = this, a = this._element.querySelector(P), c = this._getItemIndex(a), u = i || a && this._getItemByDirection(t, a), d = this._getItemIndex(u), h = Boolean(this._interval);
            if (s = t === j ? (n = "carousel-item-left",
            ...
            u && e(u).hasClass(O))
                ...
                if (e(this._element).hasClass("slide")) {
                    ...
                    e(a).one(l.TRANSITION_END, function() {
                        e(u).removeClass(n + " " + o).addClass(O),
                        e(a).removeClass(O + " " + o + " " + n),
                        r._isSliding = !1,
                        setTimeout(function() {
    ...
    e(document).on(z.CLICK_DATA_API, "[data-slide], [data-slide-to]", H._dataApiClickHandler),
    ...
    e.fn[M] = H._jQueryInterface,
    e.fn[M].Constructor = H,
    e.fn[M].noConflict = function() {
        return e.fn[M] = N,
        H._jQueryInterface
    }
    ...
    var B = "collapse"
      ...
      , K = function() {
        ...
        i.show = function() {
            ...
            i && (n = e(i).not(this._selector).data(q)) && n._isTransitioning))) {
                ...
                !i.isDefaultPrevented()) {
                    ...
                    if (0 < o)
                        for (var s = 0; s < o; s++) {
                            ...
                            null !== a && (e([].slice.call(document.querySelectorAll(a))).hasClass(G) || e(r).addClass(V).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0),
        ...
        t._jQueryInterface = function(i) {
            return this.each(function() {
                var n = e(this)
                  , o = n.data(q)
                  , s = r({}, U, {}, n.data(), {}, "object" == typeof i && i ? i : {});
      ...
      , pt = function() {
        ...
        t._clearMenus = function(i) {
            if (!i || 3 !== i.which && ("keyup" !== i.type || 9 === i.which))
                for (var n = [].slice.call(document.querySelectorAll(ut)), o = 0, s = n.length; o < s; o++) {
        ...
        t._dataApiKeydownHandler = function(i) {
            if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || e(i.target).closest(dt).length)) : st.test(i.which)) && (i.preventDefault(),
            i.stopPropagation(),
    ...
    e(document).on(rt.KEYDOWN_DATA_API, ut, pt._dataApiKeydownHandler).on(rt.KEYDOWN_DATA_API, dt, pt._dataApiKeydownHandler).on(rt.CLICK_DATA_API + " " + rt.KEYUP_DATA_API, pt._clearMenus).on(rt.CLICK_DATA_API, ut, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
    ...
    var mt = "modal"
      ...
      , Et = function() {
        function t(t, e) {
            this._config = this._getConfig(e),
            this._element = t,
            this._dialog = t.querySelector(Mt),
            this._backdrop = null,
            this._isShown = !1,
        ...
        t._jQueryInterface = function(i, n) {
            return this.each(function() {
                var o = e(this).data(gt)
                  , s = r({}, wt, {}, e(this).data(), {}, "object" == typeof i && i ? i : {});
                if (o || (o = new t(this,s),
                e(this).data(gt, o)),
                "string" == typeof i) {
                    if (void 0 === o[i])
    ...
    e(document).on(xt.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        ...
        Et._jQueryInterface.call(e(i), s, this)
    }),
    e.fn[mt] = Et._jQueryInterface,
    e.fn[mt].Constructor = Et,
      ...
      , Xt = function() {
        ...
        n.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                e.contains(this.element.ownerDocument.documentElement, this.tip) || e(r).appendTo(d),
                e(this.element).trigger(this.constructor.Event.INSERTED),
                this._popper = new i(this.element,r,this._getPopperConfig(u)),
                e(r).addClass(Zt),
    ...
    e.fn[Vt] = re._jQueryInterface,
    e.fn[Vt].Constructor = re,
    ...
    var ae = "scrollspy"
      ...
      , be = function() {
        ...
        ,
        i._getConfig = function(t) {
            if ("string" != typeof (t = r({}, de, {}, "object" == typeof t && t ? t : {})).target) {
      ...
      , Le = function() {
        ...
        return i.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(_e) || e(this._element).hasClass("disabled"))) {
                ...
                if (o) {
                    var r = "UL" === o.nodeName || "OL" === o.nodeName ? Te : Me;
        ...
        i._activate = function(t, i, n) {
            ...
            var s = this
              , r = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? e(i).children(Me) : e(i).find(Te))[0]
    ...
    var Ee = "toast"
      ...
      , We = function() {
        ...
        i.dispose = function() {
            clearTimeout(this._timeout),
            this._timeout = null,
            this._element.classList.contains(ze) && this._element.classList.remove(ze),
        ...
        ,
        i._getConfig = function(t) {
            return t = r({}, Re, {}, e(this._element).data(), {}, "object" == typeof t && t ? t : {}),
            l.typeCheckConfig(Ee, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        i._close = function() {
            ...
            var i = this;
            if (this._element.classList.remove(ze),
            this._config.animation) {
                var n = l.getTransitionDurationFromElement(this._element);
        ...
        n.compareCheck = function(t, e, i) {
            ...
            case "inside":
                ...
                if (c === r.length - 1)
                    ...
                    var u = n.getBreakpointWidth(r[c + 1].name);
                    l = o >= a && o < u
                }
            }
            l && i()
...
function(t, e) {
    ...
    o.fadeSlides = function() {
        if (!(this.slides.length < 2)) {
            ...
            null != this.fadeHideIndex && this.fadeHideIndex != s && this.fadeHideIndex != t.a && this.fadeHideIndex != t.b && this.slides[this.fadeHideIndex].setOpacity(0),
...
function(t) {
    ...
    var e, i, n, o, s, r, a = "Close", l = "BeforeClose", c = "MarkupParse", u = "Open", d = "Change", h = "mfp", f = "." + h, p = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, w = t(window), b = function(t, i) {
        e.ev.on(h + t + f, i)
    }, x = function(e, i, n, o) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!e.isOpen) {
                ...
                s += " mfp-close-btn-in") : e.wrap.append(C())),
    ...
    ;
    var _, M, T, L = "inline", E = function() {
        T && (M.after(T.addClass(_)).detach(),
        T = null)
    };
            ...
            getInline: function(i, n) {
                ...
                i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (M || (_ = o.hiddenClass,
                        M = x(_),
                        _ = "mfp-" + _),
                        T = s.after(M).detach().removeClass(_)),
            ...
            getImage: function(i, n) {
                var o = 0
                  , s = function() {
                    ...
                    i.hasSize = !0,
                    i.loaded = !0,
                    S("ImageLoadComplete")) : 200 > ++o ? setTimeout(s, 100) : r())
                }
                  , r = function() {
        ...
        var o = function(t) {
          ...
          , s = function(t) {
            for (var e = t.split(" "), i = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], o = {
                ...
                "%Y": t.getFullYear()
            }, s = n.dateFormat, r = n.dateFormat.match(/%[dmbByY]/g), a = 0, l = r.length; l > a; a++)
                s = s.replace(r[a], o[r[a]]);
            return s
        }
          , r = function(t) {
            for (var e = n.template, i = ["date", "tweet", "avatar", "url", "retweeted", "screen_name", "user_name"], o = 0, s = i.length; s > o; o++)
                ...
                t.each(n.items, function(t, i) {
                    if (t < e.limit) {
                        if (e.cleanDescription) {
                            var n = /<p>(.*?)<\/p>/g
                              , r = i.description;
                            n.test(r) && (i.description = r.match(n)[2],
        ...
        display: function(e) {
            ...
            void 0 === e.data || 200 !== e.meta.code || 0 === e.data.length)
                ...
                for (var h = 0; h < l; h++)
                    ...
                    r = e.data[h].images.thumbnail.height,
                    a = e.data[h].images.thumbnail.width) : "medium" === c ? (u = e.data[h].images.low_resolution.url,
                    r = e.data[h].images.low_resolution.height,
                    a = e.data[h].images.low_resolution.width) : (u = e.data[h].images.standard_resolution.url,
                    r = e.data[h].images.standard_resolution.height,
                    a = e.data[h].images.standard_resolution.width),
                    s = null !== e.data[h].caption ? t("<span>").text(e.data[h].caption.text).html() : this.messages.defaultImageAltText,
                    n = t("<img>", {
                        alt: s,
                        attr: {
                            height: r,
...
function(t, e) {
    ...
    var e = function(t, e) {
        ...
        var s = 1;
        window.devicePixelRatio > 1 && (s = window.devicePixelRatio,
        ...
        this.draw = function(t) {
            ...
            i = o.getImageData(0, 0, e.size * s, e.size * s)) : (this.clear(),
            c()) : this.clear(),
            o.lineCap = e.lineCap,
...
function(t) {
    ...
    var a = {
      ...
      , l = function(e, i, n) {
        ...
        this.$el.on("finish.countdown", n)) : this.options = t.extend({}, r, n)),
        this.setFinalDate(i),
    ...
    t.fn.countdown = function() {
        ...
        return this.each(function() {
            ...
            if (void 0 !== i) {
                var n = o[i]
                  , s = e[0];
                l.prototype.hasOwnProperty(s) ? n[s].apply(n, e.slice(1)) : null === String(s).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (n.setFinalDate.call(n, s),
        ...
        var o = this
          , s = setInterval(function() {
            ...
            var e = Math.floor(t / 864e5)
              ...
              , u = 1 === (r = String(r).length >= 2 ? r : "0" + r) ? "hour" : "hours"
        ...
        function i(e, i) {
            return !0 === e.initialized || !(t("body").width() < e.minWidth) && (function(e, i) {
                ...
                i.each(function() {
                    ...
                    0 == r ? (o.stickySidebar.css("padding-top", 0),
                    ...
                    o.onScroll = function(o) {
                        if (o.stickySidebar.is(":visible")) {
                            ...
                            if (s >= o.sidebar.offset().top + (o.paddingTop - o.options.additionalMarginTop)) {
                                ...
                                var f = u - s + o.paddingTop
                                  , p = d - s - o.paddingBottom - o.marginBottom
                                  , m = o.stickySidebar.offset().top - s
                                  , g = o.previousScrollTop - s;
                                ...
                                r = !v && m == h || !v && m == a - o.stickySidebar.outerHeight() ? "fixed" : s + m - o.sidebar.offset().top - o.paddingTop <= e.additionalMarginTop ? "static" : "absolute"
                            }
                            if ("fixed" == r) {
                                ...
                                w.transform = "translateY(" + (s + m - o.sidebar.offset().top - o.stickySidebarPaddingTop - o.stickySidebarPaddingBottom) + "px)",
                                w.top = "0px"),
                                ...
                                "static" == r && i();
                            "static" != r && 1 == o.options.updateSidebarHeight && o.sidebar.css({
        ...
        (this.settings.allow_duplicates || !this.settings.allow_duplicates && !function(e) {
            ...
            return t('[data-notify="container"]').each(function(n, o) {
                var s = t(o)
                  ...
                  , u = s.hasClass("alert-" + e.settings.type);
                return l && c && u && (i = !0),
                !i
            }),
            i
                ...
                update: function(e, i) {
                    ...
                    n)
                        ...
                        case "icon":
                            ...
                            "class" === t.settings.icon_type.toLowerCase() ? s.removeClass(t.settings.content.icon).addClass(n[o]) : (s.is("img") || s.find("img"),
                            s.attr("src", n[o])),
...
function(t, e) {
    ...
    function i(i, n, s, a, l) {
        ...
        function u(t) {
            for (var s = n.defaultImage, r = n.placeholder, a = n.imageBase, l = n.srcsetAttribute, c = n.loaderAttribute, u = n._f || {}, d = 0, h = (t = o(t).filter(function() {
                ...
                p === T && s && !f.attr(L) ? f.attr(L, s) : p === T || !r || f.css(D) && "none" !== f.css(D) || f.css(D, "url('" + r + "')")
            }
            return t
        }
        function d(t, e) {
            if (s.length) {
                for (var r = e || s, a = !1, l = n.imageBase || "", c = n.srcsetAttribute, u = n.handledName, d = 0; d < r.length; d++)
                    if (t || e || f(r[d])) {
                        ...
                        p.data(u) || n.visibleOnly && !p.is(":visible") || !((v || p.attr(c)) && (m === T && (y + v !== p.attr(L) || p.attr(c) !== p.attr(E)) || m !== T && y + v !== p.css(D)) || w) || (a = !0,
                        p.data(u, !0),
                        h(p, m, y, w))
                    }
        ...
        function h(t, e, i, s) {
            ...
            if (s) {
                ...
                var m = o(new Image);
                m.one(M, r).one(_, function() {
                    t.hide(),
                    e === T ? t.attr(N, m.attr(N)).attr(E, m.attr(E)).attr(L, m.attr(L)) : t.css(D, "url('" + m.attr(L) + "')"),
                ...
                m.attr(N, t.attr(c)).attr(E, t.attr(l)).attr(L, g ? i + g : null),
    ...
    o.Lazy = o.lazy = function(t, i, s) {
        if (o.isFunction(i) && (s = i,
        i = []),
        o.isFunction(s)) {
            t = o.isArray(t) ? t : [t],
            i = o.isArray(i) ? i : [i];
            for (var r = n.prototype.config, a = r._f || (r._f = {}), l = 0, c = t.length; l < c; l++)
    ...
    t.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var a in this.waypoints[s]) {
                var l, c, u, d, h = this.waypoints[s][a], f = h.options.offset, p = h.triggerPoint, m = 0, g = null == p;
                h.element !== h.element.window && (m = h.adapter.offset()[r.offsetProp]),
                "function" == typeof f ? f = f.apply(h) : "string" == typeof f && (f = parseFloat(f),
                h.options.offset.indexOf("%") > -1 && (f = Math.ceil(r.contextDimension * f / 100))),
                l = r.contextScroll - r.contextOffset,
                h.triggerPoint = Math.floor(m + l - f),
                c = p < r.oldScroll,
                u = h.triggerPoint >= r.oldScroll,
                d = !c && !u,
                !g && c && u ? (h.queueTrigger(r.backward),
                o[h.group.id] = h.group) : !g && d ? (h.queueTrigger(r.forward),
                o[h.group.id] = h.group) : g && r.oldScroll >= h.triggerPoint && (h.queueTrigger(r.forward),
        ...
        customHeight: function(e) {
            ...
            i.length > 0 && i.each(function() {
                var i = t(this)
                  ...
                  , s = i.attr("data-height-md") || o
                  , r = i.attr("data-height-sm") || s
                  , a = i.attr("data-height-xs") || r;
                function l(e) {
                    switch (e && (i = e),
    ...
    INSPIRO.header = {
        ...
        logoStatus: function(e) {
            var i = a.find(t(".logo-default"))
              ...
              , o = a.find(".logo-fixed")
              , r = a.find(".logo-responsive");
            s.hasClass("header-sticky") && o.length > 0 ? (i.css("display", "none"),
            n.css("display", "none"),
            r.css("display", "none"),
        ...
        stickyHeader: function() {
            var i = t(this)
              ...
              , a = e.scrollTop();
            s.hasClass("header-modern") && (n = 300),
            t(window).breakpoints("greaterEqualTo", "lg", function() {
                s.is(".header-disable-fixed") || (a > m + n ? (s.addClass("header-sticky"),
                a > m + o && (s.addClass("sticky-active"),
                g.submenuLight && (s.removeClass("dark"),
                !0),
                INSPIRO.header.logoStatus())) : (s.removeClass().addClass(r),
                INSPIRO.header.logoStatus()))
            }),
            t(window).breakpoints("lessThan", "lg", function() {
                "true" == s.attr("data-responsive-fixed") && (a > m + n ? (s.addClass("header-sticky"),
                a > m + o && (s.addClass("sticky-active"),
                g.submenuLight && (s.removeClass("dark"),
                !0),
                INSPIRO.header.logoStatus())) : (s.removeClass().addClass(r),
        ...
        mainMenu: function() {
            if (l.length > 0) {
                var n, o = t("#mainMenu nav > ul > li.dropdown > a, .dropdown-submenu > a, .dropdown-submenu > span, .page-menu nav > ul > li.dropdown > a"), r = t("#mainMenu-trigger a, #mainMenu-trigger button"), a = !1;
                    ...
                    t(window).breakpoints("lessThan", "lg", function() {
                        ...
                        l.animate({
                            ...
                            start: function() {
                                ...
                                r.removeClass("toggle-active"),
                                g.submenuLight && n && s.addClass("dark")
                            },
                            duration: 500,
            ...
            if (d.length > 0) {
                ...
                function n(e) {
                    ...
                    n.each(function(e) {
                        var n = t(this)
                          ...
                          , s = n.attr("data-caption-animate") || i;
                        setTimeout(function() {
                            n.css({
                                opacity: 1
                            }),
                ...
                d.each(function() {
                    ...
                    i.on("change.flickity", function() {
                        ...
                        function(t) {
                            t.find(".slide.is-selected").hasClass("slide-dark") ? s.removeClass("dark").addClass("dark-removed") : !s.hasClass("sticky-active") && s.hasClass("dark-removed") && s.addClass("dark").removeClass("dark-removed")
                        }(e),
                        a(e),
                        n(t),
                        e.find(".slide video").each(function(t, e) {
        ...
        carousel: function(e) {
            ...
            h.length > 0) {
                ...
                h.each(function() {
                    ...
                    1 !== Number(n.options.items) ? n.options.autoWidth || s ? n.find(".polo-carousel-item").css({
                    ...
                    (n.options.autoWidth || s) && (n.options.cellAlign = "center"),
                    ...
                    1 !== Number(n.options.items) && t(window).on("resize", function() {
                        setTimeout(function() {
                            ...
                            n.options.autoWidth || s ? n.find(".polo-carousel-item").css({
                                "padding-right": n.options.margin + "px"
    ...
    INSPIRO.elements = {
                    ...
                    t.ajax({
                        ...
                        success: function(r) {
                            if ("success" == r.response)
                                ...
                                t.notify({
                                    message: e.attr("data-error-message") || r.message
                                }, {
                                    type: "danger"
                                });
                                setTimeout(function() {
        ...
        naTo: function() {
            t("a.scroll-to, #dotsMenu > ul > li > a, .menu-one-page nav > ul > li > a").on("click", function() {
                ...
                t(window).breakpoints("lessThan", "lg", function() {
                    ...
                    !0 === s.attr("data-responsive-fixed") && (i = s.height())
                }),
                t(window).breakpoints("greaterEqualTo", "lg", function() {
                    s.length > 0 && (i = s.height())
                }),
        ...
        shapeDivider: function() {
            t(".shape-divider").each(function() {
                ...
                i.hasClass("b--desktop") ? (s.setAttribute("preserveAspectRatio", "none"),
                e.options.height ? s.setAttribute("style", "height:" + e.options.height + "px") : s.setAttribute("style", "height:" + s.height.baseVal.value + "px")) : s.setAttribute("preserveAspectRatio", "xMidYMid meet"),
        ...
        progressBar: function() {
            ...
            e.length > 0 && e.each(function(e, n) {
                var o = t(this)
                  , s = o.attr("data-percent") || "100"
                  , r = o.attr("data-delay") || "60"
                  , a = o.attr("data-type") || "%";
                ...
                var l = function() {
                    ...
                    o.delay(r).append('<span class="progress-type">' + a + '</span><span class="progress-number animated fadeIn">' + s + "</span>")
                };
        ...
        gridLayout: function() {
            if (f.length > 0) {
                ...
                f.each(function() {
                    ...
                    var s = t(n).imagesLoaded(function() {
                        s.isotope({
        ...
        gridLayoutInfinite: function(e, i, n) {
            ...
            o.on("load.infiniteScroll", function(e, i, n, r) {
                var a = t(i).find("." + s);
            ...
            o.on("append.infiniteScroll", function(i, n, o, a) {
                ...
                d.html(h),
                e.css("margin", "0 -" + r + "px -" + r + "px 0"),
                e.find("." + s).css("padding", "0 " + r + "px " + r + "px 0")
            })
        },
        tooltip: function() {
            ...
            if (e.length > 0) {
                ...
                e.each(function() {
                    var e = t(this)
                      ...
                      , s = e.attr("data-vimeo-quality") || "hd720"
                      , r = e.attr("data-vimeo-opacity") || 1
        ...
        modal: function() {
            ...
            var e = t(".modal")
              ...
              , o = t(".modal-close")
              , s = t(".cookie-notify")
              , r = s.find(".modal-confirm, .mfp-close");
            e.length > 0 && e.each(function() {
                var e = t(this)
                  , i = e.attr("data-delay") || 3e3
                  , n = e.attr("data-cookie-expire") || 365
                  , s = e.attr("data-cookie-name") || "cookieModalName2020_3"
                  , r = 1 == e.data("cookie-enabled");
            ...
            i.length > 0 && i.each(function() {
                ...
                e.hasClass("cookie-notify")) {
                    setTimeout(function() {
                        1 != l ? s.addClass("modal-active") : void 0 === Cookies.get(a) && s.addClass("modal-active")
                    }, i);
                    r.click(function() {
        ...
        notification: function(e, i, n, o, s, r, a, l, c, u) {
            var d, h;
            a = a || "fadeInDown",
            l = l || "fadeOutDown";
            r = r || "top",
                ...
                setTimeout(function() {
                    e.each(function() {
                        var e = t(this)
                          ...
                          , s = e.attr("data-loading-text") || "Loading..."
                          , r = e.attr("data-loader") || "include/twitter/tweet.php"
            ...
            if (e.length > 0) {
                ...
                e.each(function() {
                    var e = t(this)
                      ...
                      , s = e.attr("data-size") || "small"
                      , r = "grid-" + n;
                    e.append('<div id="instagram-cnt" class="' + r + '"></div>'),
                    jQuery.fn.spectragram.accessData = {
                        accessToken: o
                    },
...
function(t) {
    t.fn.marquee = function(e) {
        return this.each(function() {
            var i, n, o = t.extend({}, t.fn.marquee.defaults, e), s = t(this), r = 3, a = "animation-play-state", l = !1, c = function(t, e, i) {
                ...
                toggle: function() {
                    u["resumed" == s.data("runningStatus") ? "pause" : "resume"]()
                },
                destroy: function() {
            ...
            if ("string" == typeof e)
                t.isFunction(u[e]) && (i || (i = s.find(".js-marquee-wrapper")),
                ...
                var f = s.find(".js-marquee").css({
                    "margin-right": o.gap,
                    float: "left"
                });
                if (o.duplicated && f.clone(!0).appendTo(s),
                ...
                h) {
                    ...
                    var m = s.find(".js-marquee:first").height() + o.gap;
                    ...
                    var g = s.find(".js-marquee:first").width() + o.gap
                      , v = s.width();
                ...
                o.startVisible || (r = 1)) : o.startVisible ? r = 2 : h ? I() : _();
                var M = function() {
                    ...
                    r++)),
                    h ? o.duplicated ? (2 < r && i.css("transform", "translateY(" + ("up" == o.direction ? 0 : "-" + m + "px") + ")"),
                    n = {
                        transform: "translateY(" + ("up" == o.direction ? "-" + m + "px" : 0) + ")"
                    }) : o.startVisible ? 2 === r ? (x && (x = y + " " + o.duration / 1e3 + "s " + o.delayBeforeStart / 1e3 + "s " + o.css3easing),
                    n = {
                    ...
                    }) : o.duplicated ? (2 < r && i.css("transform", "translateX(" + ("left" == o.direction ? 0 : "-" + g + "px") + ")"),
                    n = {
                    ...
                    l) {
                        ...
                        i.animate(n, o.duration, o.easing, function() {
                            s.trigger("finished"),
                            o.pauseOnCycle ? s.timer = setTimeout(M, o.delayBeforeStart) : M()
                        });
                    s.data("runningStatus", "resumed")
                };
                s.bind("pause", u.pause),
                s.bind("resume", u.resume),
                o.pauseOnHover && (s.bind("mouseenter", u.pause),
                s.bind("mouseleave", u.resume)),
                l && o.allowCss3Support ? M() : s.timer = setTimeout(M, o.delayBeforeStart)
            }
        })
    }
    ,
